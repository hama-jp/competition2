"""
Exp32: exp21 base + non-linear features (NO pseudo-labels)
- Base: exp21 (31 features, LB=0.84582)
- Add: Age_old_penalty, Agility_penalty (from Chatterjee analysis)
- No pseudo-labels (to avoid overfitting seen in exp26)
"""
import pandas as pd
import numpy as np
import os
...
EXP_DIR = '/home/user/competition2/experiments/exp32_exp21_with_nonlinear'
BASE_DIR = '/home/user/competition2'

os.makedirs(EXP_DIR, exist_ok=True)

print("=" * 60)
print("Exp32: exp21 base + non-linear features (NO pseudo-labels)")
print("=" * 60)
...
print(f"Base: exp21 (31 features)")
print(f"New: Age_old_penalty, Agility_penalty")
...
# ==========================================
# Full ensemble training (NO pseudo-labels)
# ==========================================
...
print(f"\nexp21 (31 features, no pseudo): CV = 0.85161, LB = 0.84582")
print(f"exp26 (31 features + pseudo):   CV = 0.85175, LB = 0.84466")
print(f"Difference vs exp21: {cv_final - 0.85161:+.5f}")
