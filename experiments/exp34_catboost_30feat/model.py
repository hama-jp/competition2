"""
Exp34: CatBoost only with 30 features (exp13 base)
- Uses exp13's top 30 features (no Agility_3cone_Pos_Diff)
...
EXP_DIR = '/home/user/competition2/experiments/exp34_catboost_30feat'
BASE_DIR = '/home/user/competition2'

os.makedirs(EXP_DIR, exist_ok=True)

print("=" * 60)
print("Exp34: CatBoost only (30 features)")
print("=" * 60)

# Load exp13 results - use exactly 30 features
with open('/home/user/competition2/experiments/exp13_feature_selection/results.json', 'r') as f:
    exp13_results = json.load(f)
features = exp13_results['best_features']  # 30 features
...
print("Results")
print("=" * 60)
print(f"CatBoost CV (30 feat): {cv_final:.5f}")
