"""
Exp15: Fine-tune feature count around 30
- Test 25, 28, 30, 32, 35 features
- Use 5 seeds (same as exp13 which had best LB)
"""
import pandas as pd
import numpy as np
import os
...
EXP_DIR = '/home/user/competition2/experiments/exp15_feature_tuning'

print("=" * 60)
print("Exp15: Fine-tune Feature Count")
print("=" * 60)
...
# ==========================================
# Load params and feature importance
# ==========================================
...
with open('/home/user/competition2/experiments/exp13_feature_selection/feature_importance.json', 'r') as f:
    sorted_features = json.load(f)

# ==========================================
# Training function
# ==========================================
def train_model(train_df, test_df, target, features):
    cat_cols = ['School', 'Player_Type', 'Position_Type', 'Position']
...
print("\n" + "=" * 60)
print("Testing feature counts: 25, 28, 30, 32, 35")
print("=" * 60)
...
for n in feature_counts:
    ...
    oof, pred, cv = train_model(train_df, test_df, target, features)
    results[n] = {'cv': cv, 'pred': pred, 'features': features}
    print(f"CV: {cv:.5f}")
...
for n in feature_counts:
    ...
    print(f"  {n:2} features: CV = {results[n]['cv']:.5f}{marker}")

print(f"\nExp13 (30 feat): CV = 0.85138, LB = 0.84524")
...
for n in feature_counts:
    submission = pd.DataFrame({
        'Id': test_df['Id'],
        'Drafted': results[n]['pred']
    })
    submission.to_csv(f'{EXP_DIR}/submission_{n}feat.csv', index=False)
...
# Save results
results_summary = {
    'feature_count_results': {n: results[n]['cv'] for n in feature_counts},
