"""
Exp14: 30 Features + 10 Seeds
- Use top 30 features from exp13
- Increase seeds from 5 to 10 for more stable predictions
"""
import pandas as pd
import numpy as np
import os
...
EXP_DIR = '/home/user/competition2/experiments/exp14_30feat_10seeds'

print("=" * 60)
print("Exp14: 30 Features + 10 Seeds")
print("=" * 60)
...
# ==========================================
# Load top 30 features from exp13
# ==========================================
...
print(f"Using {len(top_30_features)} features from exp13")
...
print(f"\nExp13 (30 feat, 5 seeds): CV = 0.85138, LB = 0.84524")
...
np.save(f'{EXP_DIR}/pred_final.npy', pred_final)
