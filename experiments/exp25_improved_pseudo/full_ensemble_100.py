"""
Exp25c: Full ensemble with 100 pseudo-label samples (balanced)
"""
import pandas as pd
import numpy as np
import os
...
print("=" * 60)
print(f"Exp25c: Full Ensemble with {N_PSEUDO} Pseudo-label Samples")
print("=" * 60)
...
# ==========================================
# Step 1: Get initial predictions from each model
# ==========================================
...
# ==========================================
# Step 2: Select top 100 pseudo-labels (balanced)
# ==========================================
...
pseudo_mask = np.zeros(len(test_df), dtype=bool)
pseudo_mask[selected_idx] = True
...
print(f"\nexp24 (no pseudo): CV = 0.85230, LB = ?")
print(f"Difference: {cv_final - 0.85230:+.5f}")
...
submission.to_csv(f'{EXP_DIR}/submission_100pseudo.csv', index=False)
...
with open(f'{EXP_DIR}/results_100pseudo.json', 'w') as f:
    json.dump(results, f, indent=2)

print(f"\nSubmission saved to {EXP_DIR}/submission_100pseudo.csv")
