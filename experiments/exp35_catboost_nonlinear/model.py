"""
Exp35: CatBoost only with 33 features (non-linear features)
...
EXP_DIR = '/home/user/competition2/experiments/exp35_catboost_nonlinear'
BASE_DIR = '/home/user/competition2'

os.makedirs(EXP_DIR, exist_ok=True)

print("=" * 60)
print("Exp35: CatBoost only (33 features with non-linear)")
print("=" * 60)
...
# 33 features = 30 + Agility_3cone_Pos_Diff + Age_old_penalty + Agility_penalty
features = top30_features + ['Agility_3cone_Pos_Diff', 'Age_old_penalty', 'Agility_penalty']
print(f"Features: {len(features)}")
print("Added: Agility_3cone_Pos_Diff, Age_old_penalty, Agility_penalty")
...
def get_data():
    ...
    # Non-linear features from Chatterjee analysis
...
print("Results")
print("=" * 60)
print(f"CatBoost CV (33 feat): {cv_final:.5f}")
print(f"\nexp33 (31 feat): CV = 0.85083, LB = 0.85130")
...
results = {
    ...
    'model': 'CatBoost only',
    'features_added': ['Agility_3cone_Pos_Diff', 'Age_old_penalty', 'Agility_penalty'],
    'cv_catboost': float(cv_final),
    'exp33_cv': 0.85083,
    'exp33_lb': 0.85130
}
