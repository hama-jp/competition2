"""
Exp03: Enhanced Model with Optuna Tuning + More Seeds
...
def optimize_cat(X, y, features, cat_indices):
    ...
    def objective(trial):
        params = {
            ...
            'random_seed': 42, 'iterations': 1000,
            'learning_rate': trial.suggest_float('learning_rate', 0.01, 0.1, log=True),
...
if __name__ == '__main__':
    print("="*50)
    print("Exp03: Enhanced Model with Optuna")
    print("="*50)
    ...
    oof_lgb, pred_lgb = train_lgb(train_df, target, test_df, features, bp_lgb)
    oof_xgb, pred_xgb = train_xgb(train_df, target, test_df, features, bp_xgb)
    oof_cat, pred_cat = train_cat(train_df, target, test_df, features, cat_indices, bp_cat)
    ...
    results = {
        'experiment': 'exp03_optuna_enhanced',
