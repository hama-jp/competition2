"""
Exp24: Test 30 features (31 - Bench_per_Weight)
...
print("=" * 60)
print("Exp24: Test 30 features (remove Bench_per_Weight)")
print("=" * 60)
...
# 31 features then remove Bench_per_Weight
features_31 = top30_features + ['Agility_3cone_Pos_Diff']
features_30 = [f for f in features_31 if f != 'Bench_per_Weight']
print(f"Features: {len(features_30)}")
...
X_train = train_df[features_30]
y_train = target
X_test = test_df[features_30]

cat_indices = [features_30.index(c) for c in cat_cols if c in features_30]
